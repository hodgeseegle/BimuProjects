 ...
 * 评论详情页
 */
public class CommentDetailActivity extends BaseActivity implements View.OnClickListener, AdapterView.OnItemClickListener, TextView.OnEditorActionListener, LoadMoreListView.OnRefreshListener {
    ...
    private int index =1 ; //从消息列表进来，滚动到哪个位置
    ...
    private void setData(ArticleDetailResponse response) {
        for(int i =0;i<response.getComments().size();i++){
            if(response.getComments().get(i).getComment_id().equals(comment_pos)){
                index = i+1;
                break;
            }
        }
        ...
        if(response.getHas_praised()==1){
            hasParised = true;
            iv_parised.setImageResource(R.drawable.img_love_select);
        }else{
            hasParised = false;
            iv_parised.setImageResource(R.drawable.praised);
        }
        ...
        new ShareAction(this)
                ...
                .setCallback(new UMShareListener() {
                    ...
                    public void onResult(SHARE_MEDIA share_media) {
                        ToastUtils.showShort(CommentDetailActivity.this,"分享成功");
                    }

                    @Override
                    public void onError(SHARE_MEDIA share_media, Throwable throwable) {
                        ToastUtils.showShort(CommentDetailActivity.this,"分享失败");
                    }

                    @Override
                    public void onCancel(SHARE_MEDIA share_media) {
                        ToastUtils.showShort(CommentDetailActivity.this,"分享已取消");
                    }
                })
    ...
    public void onItemClick(AdapterView<?> adapterView, View view, int i, long l) {
        switch (adapterView.getId()){
            ...
            case R.id.lv_article_detail://点击评论区
                ...
                AppUtils.showSoftInput(CommentDetailActivity.this, et);
                break;
        }
    }
                    ...
                    HttpUtils.postWithoutUid(MethodConstant.ARTICLE_DETAIL, re, new ResponseHook() {
                        ...
                        public void deal(Context context, JsonReceive receive) {
                            ...
                            if(response!=null){
                                ...
                                ToastUtils.show(CommentDetailActivity.this,"评论成功",Toast.LENGTH_SHORT);
                                list.clear();
                                list.addAll(response.getComments());
                                adapter.notifyDataSetChanged();
                            }
