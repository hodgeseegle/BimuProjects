...
public class BrandAssessAdapter extends BaseAdapter {

    private Context context;
    private List<BrandResponse.ArticledataBean> list;

    public BrandAssessAdapter(Context context, List<BrandResponse.ArticledataBean> list){
