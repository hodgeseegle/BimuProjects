...
public class HomeHotBrandAdapter extends BaseAdapter {

    private List<HomePagerResponse.BrandlistBean.DataBean> list;
    private Context context;

    public HomeHotBrandAdapter(Context context, List<HomePagerResponse.BrandlistBean.DataBean> list){
    ...
    public View getView(int position, View convertView, ViewGroup viewGroup) {
        ...
        HomePagerResponse.BrandlistBean.DataBean bean = list.get(position);
